...
async function exportCard(card, targetDir, args) {
  ...
  case 'photo': {
    ...
    return {
      ...pick(card, ['cardType', 'path', 'width', 'height', 'meta']),
      sources
    };
  }
...
export default class Config {
   ...
   */
  static async addCardForExport(exportConfig, card, targetDir, args) {
    const { cards = [] } = exportConfig;
    return { ...exportConfig, cards: [...cards, await exportCard(card, targetDir, args)] };
  }
