...
async function exportHeap(args) {
  ...
  if (args.awsBucket != null && (args.awsPath == null || args.awsRegion == null)) {
    Log.error('When using AWS S3 via aws-bucket, aws-path and aws-region are required!');
    process.exit(-1);
  }
...
export const builder = yargs => {
  yargs.options({
    ...
    'aws-region': {
      describe: 'The region of the AWS bucket. Required if aws-bucket is used.'
    },
    'aws-path': {
